...
* Analysis of interaction effect is possible, however laborious, via separate t-tests
* Power could be improved without increased total sample size by appropriately increasing the size of the control group (not shown here)
